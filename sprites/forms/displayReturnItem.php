<?php 
function displayReturnItem($message,$errorArray,$valuesArray,$errorFlag,$errorType){
    ...
    <td><table id="forms" cellpadding="0" cellspacing="0" border="0" >
        <tr>
          ...
          <td align="center" ><table cellpadding="0" cellspacing="0" border="0" align="right" id="rightBoby">
              <tr>
                <td valign="top">
                <form action="/Myshop/administrator.php" method="post" name="returnItem" id="returnItem">
                    <input id="frmName" name="frmName" value="returnItem" type="hidden" />
                    <input id="saleID" name="saleID" value="<?php echo $valuesArray["saleID"];?>" type="hidden" />
		    ...
		    <input id="costPrice" name="costPrice" value="<?php echo $valuesArray["costPrice"];?>" type="hidden" />
                    ...
                    <input id="sellingPrice" name="sellingPrice" value="<?php echo $valuesArray["sellingPrice"];?>" type="hidden" />
                    <input id="discount" name="discount" value="<?php echo $valuesArray["discount"];?>" type="hidden" />
                    <input id="recieptNumber" name="recieptNumber" value="<?php echo $valuesArray["recieptNumber"];?>" type="hidden" />
		  ...
		  if($valuesArray["address"] == ""){$valuesArray["address"] ="-";}
 		  ?>
                    ...
                    <div id="formFields" align="left">
                      ...
                      <textarea name="reason" cols="30" rows="5" class="textarea"><?php if ($errorFlag == true){echo $valuesArray["reason"];}?>
</textarea>
