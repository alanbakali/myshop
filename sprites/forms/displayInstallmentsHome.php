<?php 
function displayInstallmentsHome($message,$errorArray,$valuesArray,$errorFlag,$errorType){
?>
                ...
                <tr valign="top">
                  <td align="left"></div>
                   <form action="/Myshop/administrator.php" method="post" name="viewInstallments" id="viewInstallments">
                        ...
                        <input id="actualFormName" name="actualFormName" value="instalmentsHome" type="hidden" />
