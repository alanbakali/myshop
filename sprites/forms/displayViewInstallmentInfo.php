<?php 
function displayViewInstallmentInfo($message,$errorArray,$valuesArray,$errorFlag,$errorType){
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td><table cellpadding="0" cellspacing="0" border="0" id="formHeader" width="100%">
        <tr>
          <td>Installments - Installment Info</td>
        ...
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" border="0" align="right" id="rightBoby">
              ...
              <div id="formFields">
                ...
                <div id="itemInfo">
                  <?php  echo $valuesArray["description"]; ?>
                </div>
              </div>
              <div id="formFields">
              ...
              <div id="formFields">
                ...
                <div id="itemInfo"><?php echo $valuesArray["itemID"];?></div>
              </div>
              <div id="formFields">
                <div id="formLine">&nbsp;</div>
              </div>
