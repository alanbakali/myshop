<?php 
function displayDownPaymentsHome($message,$errorArray,$valuesArray,$errorFlag,$errorType){
?>
  ...
  <tr>
    <td><table id="forms" cellpadding="0" cellspacing="0" border="0" >
        <tr>
          ...
          <td align="left"><table  cellpadding="0" cellspacing="0" border="0"  id="rightBoby">
              <tr>
                <td valign="top"><table  cellpadding="0" cellspacing="0" border="0" align="left" width="100%">
                    <tr valign="top">
                      <td align="left"></div>
                        <form action="/Myshop/administrator.php" method="post" name="viewDownPayments">
                          <input id="frmName" name="frmName" value="viewDownPayments" type="hidden" />
                          <input id="actualFormName" name="actualFormName" value="downPaymentsHome" type="hidden" />
