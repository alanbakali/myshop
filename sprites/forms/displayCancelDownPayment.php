<?php 
function displayCancelDownPayment($message,$errorArray,$valuesArray,$errorFlag,$errorType){
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td><table cellpadding="0" cellspacing="0" border="0" id="formHeader" width="100%">
        <tr>
          <td>DownPayment - Cancel DownPayment</td>
    ...
    <td><table id="forms" cellpadding="0" cellspacing="0" border="0" >
        <tr>
          ...
          <td align="center" ><table cellpadding="0" cellspacing="0" border="0" align="right" id="rightBoby">
              <tr>
                <td valign="top">
                <form action="/Myshop/administrator.php" method="post" name="cancelDownPayment" id="cancelDownPayment">
                    <input id="frmName" name="frmName" value="cancelDownPayment" type="hidden" />
                    <input id="downPaymentID" name="downPaymentID" value="<?php echo $valuesArray["downPaymentID"];?>" type="hidden" />
                    <input id="serial" name="serial" value="<?php echo $valuesArray["serial"];?>" type="hidden" />
