<?php 
function displayEditUser($message,$errorArray,$valuesArray,$errorFlag,$errorType){
?>
    ...
    <td><table id="forms" cellpadding="0" cellspacing="0" border="0" >
        <tr>
          ...
          <td align="center" ><table cellpadding="0" cellspacing="0" border="0" align="right" id="rightBoby">
              <tr>
                <td valign="top"><form action="/Myshop/administrator.php" method="post" name="editUser" id="editUser" >
                    <input id="frmName" name="frmName" value="editUser" type="hidden" />
		    <input id="userID" name="userID" value="<?php echo $valuesArray["userID"];?>" type="hidden" />
                    ...
                    <div id="formFields">
                      ...
                      <input id="disabled" name="userName" type="text" maxlength="15" size="15" readonly="readonly"
