<?php 
function displayDefineExpense($message,$errorArray,$valuesArray,$errorFlag,$errorType){
?>
	...
	<tr>
       ...
       <?php displayExpensesMenu(); ?>
        ...
        <td align="left">
            ...
            <tr>
                <td>
                 <form action="/Myshop/administrator.php" method="post" name="defineExpense" id="defineExpense">
                  <input id="frmName" name="frmName" value="defineExpense" type="hidden" />
