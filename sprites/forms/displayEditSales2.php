<?php 
function displayEditSales2($message,$errorArray,$valuesArray,$errorFlag,$errorType){
...
$valuesArray["discount"] = ($valuesArray["totalCostPrice"] - $valuesArray["sellingPrice"]);
...
<table id="forms" cellpadding="0" cellspacing="0" border="0" >
	<tr>
        ...
        <td left >
            ...
            <tr>
                <td valign="top">
                  <form action="/Myshop/administrator.php" method="post" name="editSales2" id="editSales2">
                  <input id="frmName" name="frmName" value="editSales2" type="hidden" />
                   ...
                   <input id="initialSaleQuantity" name="initialSaleQuantity" value="<?php echo $valuesArray["initialSaleQuantity"];?>" type="hidden" />
                  ...
                  <div id="formFields">
                     ...
                     <div id="formFields">
                        ...
                        <input id="disabled" name="saleID" type="text" maxlength="10" size="7" readonly="readonly"
                      ...
                      <div id="formFields">
                        ...
                        onchange="return calculateTotalPrice(document.editSales2);"
                      ...
                      <div id="formFields">
                        ...
                        onmouseout="return calculateDiscount(document.editSales2);"
                      ...
                      <div id="formFields">
                        ...
                        onmouseout="return calculateTotalPrice(document.editSales2);"
                    ...
                    ontextchange="return calculateDiscount(document.editSales2);"
                   ...
                   <div id="formFields"> 
                    ...
                    onmouseover="return calculateTotalPrice(document.editSales2);"/>
            ...
            <tr valign="bottom">
             	<td id="formFields" height="40"><label for="serial"><small id="optional">*</small>&nbsp;Optional Field</label></td>
            </tr>
