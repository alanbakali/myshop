<?php 
function displayEnterInstallment2($message,$errorArray,$valuesArray,$errorFlag,$errorType){
if(($valuesArray["installmentID"] =="")){
$query = "SELECT installmentID FROM installments ORDER BY installmentID DESC";
...
if(mysql_num_rows($result) >= 1) {
	...
	$valuesArray["installmentID"]= htmlspecialchars(stripslashes($row["installmentID"])) + 1;
}

if(mysql_num_rows($result) == 0) {
	$errorFlag=true;			
	$row = mysql_fetch_array($result);
	$valuesArray["installmentID"]= 1000;
}
}
    ...
    <td><table id="forms" cellpadding="0" cellspacing="0" border="0" >
        <tr>
          ...
          <td align="center" ><table cellpadding="0" cellspacing="0" border="0" align="right" id="rightBoby">
              <tr>
                <td valign="top"><form action="/Myshop/administrator.php" method="post" name="enterInstallment" id="enterInstallment" >
                    <input id="frmName" name="frmName" value="enterInstallment" type="hidden" />
                    ...
                    <div id="formFields">
                      ...
                      <input id="installmentID" name="installmentID" type="text" maxlength="10" size="7"
