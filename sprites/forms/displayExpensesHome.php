<?php 
function displayExpensesHome($message,$errorArray,$valuesArray,$errorFlag,$errorType){
?>
	...
	<tr>
        ...
        <td align="center" >
            ...
            <td valign="top"><table  cellpadding="0" cellspacing="0" border="0" align="left" width="100%">
                <tr valign="top">
                  <td align="left">
                   <form action="/Myshop/administrator.php" method="post" name="viewExpenses">
                      <input id="frmName" name="frmName" value="viewExpenses" type="hidden" />
                      <input id="actualFormName" name="actualFormName" value="expensesHome" type="hidden" />
