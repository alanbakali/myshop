<?php 
function displayLastPaymentDownPayment2($message,$errorArray,$valuesArray,$errorFlag,$errorType){
    ...
    <td><table id="forms" cellpadding="0" cellspacing="0" border="0" >
        <tr>
          ...
          <td align="center" ><table cellpadding="0" cellspacing="0" border="0" align="right" id="rightBoby">
              <tr>
                <td valign="top"><form action="/Myshop/administrator.php" method="post" name="lastPaymentDownPayment2" id="lastPaymentDownPayment2" >
                    <input id="frmName" name="frmName" value="lastPaymentDownPayment2" type="hidden" />
                    ...
                    <input id="downPaymentID" name="downPaymentID" value="<?php echo $valuesArray["downPaymentID"];?>" type="hidden" />
		  ...
		  if($valuesArray["address"] == ""){$valuesArray["address"] ="-";}
 		  ?>
		  <div id="formFields">&nbsp; </div><div id="formFields">&nbsp; </div>
                  <div id="formFields">
                  ...
                  <div id="formFields">
                    ...
                    <div id="formFields">
                        <label for="serial">Item Serial:&nbsp;<small id="optional">*</small></label>
                    ...
                    <div id="formFields">
                      ...
                      <input id="lastPayment" name="lastPayment" type="text" maxlength="15" size="15"
                      onmouseout="return calculateLastBalance(this.form);"
                        <?php if ($errorFlag == true){ $value = $valuesArray["lastPayment"]; echo "value=\"$value\" "; }?> />
                      <?php if($errorFlag == true){ echo $errorArray["lastPayment"];} ?>
                    </div>
                    <div id="formFields">
                      <label for="recieptNumber2">Reciept Number:</label>
